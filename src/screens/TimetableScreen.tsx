...
const styles = StyleSheet.create({
    ...
    subjectText: { fontSize: 13, fontWeight: '800', color: '#37474F', marginBottom: 3, textAlign: 'center', textShadowColor: 'rgba(0, 0, 0, 0.1)', textShadowOffset: { width: 0.5, height: 0.5 }, textShadowRadius: 1, },
    teacherContextText: { fontSize: 10, color: '#78909C', textAlign: 'center', marginTop: 2, fontWeight: '500', },
    classGroupText: { fontSize: 11, color: '#5E35B1', fontWeight: '700', textAlign: 'center', marginTop: 2, },
