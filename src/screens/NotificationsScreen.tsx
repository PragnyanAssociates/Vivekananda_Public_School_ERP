...
// --- UPDATED DATE HELPER (FIX FOR +5:30 OFFSET) ---
const formatNotificationDate = (dateInput) => {
    ...
    try {
        ...
        if (dateInput instanceof Date) {
            ...
            // ★★★ FIX START: Remove 'Z' to prevent automatic timezone conversion ★★★
            if (dateString.includes('Z')) {
                dateString = dateString.replace('Z', '');
            }
            // ★★★ FIX END ★★★

            // Ensure ISO format for valid parsing
