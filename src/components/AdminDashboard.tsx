...
const AdminDashboard = ({ navigation }) => {
  ...
  const allQuickAccessItems = [
    ...
    { id: 'qa3', title: 'Students Status Report', imageSource: 'https://cdn-icons-png.flaticon.com/128/15175/15175651.png', navigateToTab: 'PerformanceFilter' },
    { id: 'qa4', title: 'Teachers Status Report', imageSource: 'https://cdn-icons-png.flaticon.com/128/3094/3094829.png', navigateToTab: 'TeacherFilter' },
